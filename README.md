...
## v1.4.1 模糊搜尋
- 英文大小寫不敏感：iPhone / IPHONE / iphone 都可。
- 空白與常見符號不敏感：`iphone18256g` 可辨識為 `iPhone 18 256GB`。
- 容量格式統一：256G / 256GB、1T / 1TB 視為同規格。
- 常見中文別名：愛瘋／唉鳳／哀鳳會轉成 iPhone。
- 官網直查、Google 備援與比價網補查都使用正規化後的搜尋字串。
